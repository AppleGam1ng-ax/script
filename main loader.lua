...
if game.PlaceId == 6808416928 then --Aimblox
    ...
    elseif game.PlaceId == 10320240572 then --Easy Race Clicker
    ...
    elseif game.PlaceId == 662417684 then --Lucky Blocks
    ...
    else if game.PlaceId == 9414511685 then --Drive Down Cars A Hill
